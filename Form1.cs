...
namespace ReajustePagamento
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            dgvResultados.DataSource = leituraSource;
        }
        ...
        private void TotalizarValores(IList<Funcionario> dadosLidos)
        {
            ...
            foreach (var funciona in dadosLidos)
            {
                totalSemReajuste += funciona.Salario;
                totalComReajuste += funciona.NovoSalario;
            }
            ...
            lblPercentualReajuste.Text = String.Format("{0:c}", percentualReajuste);
        }
    }
}
